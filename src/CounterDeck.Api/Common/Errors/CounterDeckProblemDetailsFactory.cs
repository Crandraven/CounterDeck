...
namespace CounterDeck.Api.Common.Errors;

public class CounterDeckProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;

    public CounterDeckProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
